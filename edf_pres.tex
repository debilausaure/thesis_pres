...
%%%%	Introduction
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Introduction \& présentation des travaux}
...
\begin{frame}[fragile]
	\frametitle{Positionnement des travaux dans le projet Pip}
	\begin{itemize}
		\item{Critical software of embedded systems}
		\item{EDF is optimal and well understood}
		\item{Experiment with our proof methodology}
...
\section{Abstraction des modèles de Pip}

\begin{frame}[fragile]
coucou
\end{frame}

\subsection{Ancien modèle}
