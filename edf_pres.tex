...
\begin{frame}[fragile]
	\frametitle{Politique d'ordonnancement Earliest Deadline First}
...
\begin{frame}[fragile]
	\frametitle{Bon fonctionnement d'une fonction d'élection intermédiaire}

	Implémentation d'une fonction d'élection idéalisée qui se comporte de la même manière que la fonction d'élection réelle.\\[0.5cm]

	La prochaine étape est de montrer que cette fonction d'élection idéalisée implémente la politique EDF définie précédemment.

	\begin{block}{Fonction d'élection idéalisée implémente la politique EDF}
	\vspace{-0.2cm}
	\[
	...
	De cette propriété découle la propriété de bon fonctionnement de la fonction d'élection idéalisée.

\end{frame}

\begin{frame}[fragile]
	\frametitle{Bon fonctionnement de la fonction d'élection}

	Implémentation de la fonction d'élection réelle, traductible en C, \emph{reposant sur des primitives prédéfinies}.\\[0.5cm]

	La dernière étape consiste à prouver que la fonction d'élection a le même comprtement que la fonction d'élection idéalisée.

	\begin{block}{Fonction d'élection se comporte comme la fonction d'élection idéalisée}
		\vspace{-0.6cm}
		\begin{gather*}
			\forall t.\\
			\{
	...
	De cette propriété découle la propriété de bon fonctionnement de la fonction d'élection, et donc de notre ordonnanceur.
